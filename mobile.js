...
function showAdminFeedback(id, data, announce = false) {
  ...
  if (announce) { adminStatus("وصل اقتراح جديد الآن."); const toast = document.createElement("div"); toast.className = "admin-toast"; toast.textContent = `اقتراح جديد من ${data.author || "طالب"}`; document.body.append(toast); setTimeout(() => toast.remove(), 6000); }
}
